...
st.title("💬 AI Powered Virtual Assistant for Facility Management")

# Sidebar content
logo_path = "/home/atharva/Music/Ollama_chatbot/Inference/MosChip-DigitaSky-Logo.jpg"  # Update with your logo path
logo = Image.open(logo_path)
st.sidebar.image(logo,use_container_width=True)

if "chatbot" not in st.session_state:
    st.session_state.chatbot = OllamaChat()
